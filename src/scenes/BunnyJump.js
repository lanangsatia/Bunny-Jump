...

{
    ...
    preload()
    {
        ...
        this.load.image('platform', 'img/Assets/ground_grass.png')
        this.load.image('carrot', 'img/Assets/carrot.png')
        this.load.image('bunny_jump', 'img/Assets/bunny1_jump.png')
        this.load.image('bunny_stand', 'img/Assets/bunny1_stand.png')
        this.load.audio('jumpSound', 'img/Assets/phaseJump1.ogg') 
    ...
    create()
    {
        ...
        //off the collision player w/ platforms
        ...
        //this.add.text(80, 10, 'Carrots: 0', style).setScrollFactor(0).setOrigin(0.5,0)
